        ...
        {active === 0 && (
          <div className="protech-slide protech-dashboard-slide">
            ...
            <div className="protech-dashboard-grid">
              ...
              <div className="protech-comparison">
                <p>Development since prior season</p>
                <div><span>Power</span><strong>92</strong><em>+8%</em></div>
                <div><span>Speed</span><strong>87</strong><em>+4%</em></div>
                <div><span>Force</span><strong>84</strong><em>+6%</em></div>
                <small>Weight · Jump · Strength · ForcePlate · NordBord</small>
              </div>
            </div>
            <div className="metric-ribbon carousel-metrics"><span>MULTI-YEAR RECORDS</span><span>PLAYER + POSITION VIEW</span><span>COACHING WORKFLOW</span></div>
          </div>
        )}
